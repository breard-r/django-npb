...
class PasteAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ...
        (_("Administration"), {"fields": ["is_suspended", "suspension_reason"]}),
    ]
...
class ReportAdmin(admin.ModelAdmin):
    ...
    def paste_url(self, obj):
        return mark_safe(
            ...
            % {"url": obj.paste.get_absolute_url(), "name": obj.paste.uuid}
        )
    ...
    def paste_admin_url(self, obj):
        return mark_safe(
            ...
            % {
                "url": reverse(
                    "admin:%s_%s_change"
                    % (obj.paste._meta.app_label, obj.paste._meta.model_name),
                    args=[obj.paste.uuid],
                ),
